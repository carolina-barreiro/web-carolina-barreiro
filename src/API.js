...
export default function FormContact(props) {
  ...
  return (
    <>
      <div className="App">
        <form
          className="pr-2 mb-3 mt-5 font-spline"
          onSubmit={onSubmit}
          noValidate
        >
          <Row className="mb-3">
            <Col md={6} className="form-group">
              <input
                type="text"
                required
                className={`form-control ${fnameError ? "error" : ""}`}
                name="fname"
                id="fname"
                placeholder="Name"
              />
          ...
          <Row className="mb-3">
            <Col md={12} className="center-button">
              <button
                className={`btn-custom font-spline ${
                  props.noturnView ? "dark-mode-background" : ""
                }`}
                type="submit"
              >
                {" "}
