...
function Footer(props) {
  ...
  return (
    <div className={`${props.noturnView ? "dark-mode-background" : ""}`}>
      <Container fluid className="mx-auto py-4" style={{ width: "80%" }}>
        <Row className="align-items-center">
          <Col xs={12} md={4} lg={4} className="text-md-start mb-3 mb-md-0">
            <div className="card-footer">
              <span className="h5 mb-0 font-outfit">Carolina Barreiro</span>{" "}
              {props.noturnView ? (
                <a
          ...
          <Col xs={12} md={4} lg={4} className="text-center mb-3 mb-md-0">
            {/* Add any content for the center column */}
          </Col>
          <Col xs={12} md={4} lg={4} className="text-md-end">
            <div className="card-footer">
              <Button
                className="p-2 socialContainer"
                href="https://linkedin.com/in/carolina-barreiro-12ba7720a"
                target="_blank"
              >
              ...
              <Button
                className="p-2 socialContainer"
                href="https://github.com/carolina-barreiro"
                target="_blank"
              >
